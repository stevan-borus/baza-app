...
export function ThemeSwitcher() {
  ...
  return (
    <YStack gap="$4">
      <XStack items="center" justify="space-between" gap="$3">
        <YStack gap="$1" flex={1}>
          ...
          <Text fontSize="$2" color="$color9">
            {isSystem ? t("settings.themeSystem") : t("settings.themeDescription")}
          </Text>
        </YStack>
        <Pressable
          onPress={() => setPreference(resolvedTheme === "dark" ? "light" : "dark")}
          style={{
            width: 62,
            height: 34,
            borderRadius: 999,
            backgroundColor:
              resolvedTheme === "dark" ? "rgba(62,94,74,0.35)" : "rgba(60,72,58,0.12)",
            ...
            style={[
              {
                ...
                height: 28,
                borderRadius: 999,
                backgroundColor: resolvedTheme === "dark" ? "#dff4e7" : "#f8fafc",
                alignItems: "center",
                justifyContent: "center",
              },
              thumbTransform,
      ...
      <Pressable onPress={() => setPreference(isSystem ? resolvedTheme : "system")}>
        <XStack
          bg="$backgroundHover"
