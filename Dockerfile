...
# Sentry client DSN for the web (SSR) bundle. A DSN is publishable, so the real
# baza-mobile DSN is the default; override with --build-arg to disable/redirect.
ARG EXPO_PUBLIC_SENTRY_DSN="https://8f9d652ca9979e1d2f64f4fa908eebee@o4511682894036992.ingest.de.sentry.io/4511682919661648"
